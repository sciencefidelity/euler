...
mod tests {
    ...
    fn test_distinct_prime_factors_two() {
        assert_eq!(Euler::distinct_primes_factors(2), 14);
    }

    #[test]
    fn test_distinct_prime_factors_three() {
        assert_eq!(Euler::distinct_primes_factors(3), 644);
    }

    #[test]
    fn test_distinct_prime_factors_four() {
        assert_eq!(Euler::distinct_primes_factors(4), 134_043);
    }
}
